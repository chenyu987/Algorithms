...
// The method between Jiu Zhang and Zhe(including segment fault) have a little bit difference in while (start <= end) and while(start - 1 < end), figure out the difference and why
