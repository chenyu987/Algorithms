...
public class TheSkylineProblem {
  ...
  |      _|   |   | |    |  
  |     | |   |   | |    |               
  |     |_|___|___| |____|__________________________ x - axis|

// The number of buildings in any input list is guaranteed to be in the range [0, 10000].    
[ [2 9 10], [3 7 15], [5 12 12], [15 20 10], [19 24 8] ]     
    
    
public List<int[]> getPoints(int[][] buildings) {
  List<int[]> res = new ArrayList<int[]>;
    //10000代表pq里最多10000个components
  PriorityQueue<Integer> pq = new PriorityQueue<Integer>(10000, new Comparator<Integer>() {
    public int compare (int height1, int height2) {
//       从大到小是height2 - height1， 从小到大反之
      return height2 - height1;  
    }
  }); 
